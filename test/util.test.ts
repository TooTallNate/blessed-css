...
test('isStyles()', async () => {
	assert.equal(isStyles({}), true);
	assert.equal(isStyles({ fg: 'blue' }), true);
	assert.equal(isStyles({ bold: true }), true);
	assert.equal(isStyles(true), false);
	assert.equal(isStyles(false), false);
	assert.equal(isStyles(1), false);
	assert.equal(isStyles(() => {}), false);
	assert.equal(isStyles('not styles'), false);
});
